...
let regExp1 = /^'|(\s)'|'(\s)|'$/g;
let text = 'Lorem \'ipsum\' do\'lor \"sit\", amet \"consectetur\" adipisicing elit.Architecto, accusantium eum adipisci consequat\'ur magnam \'quaerat itaque\' natus error ex nostrum laudantium veniam hic! Voluptatibus, reprehenderi\'t.Tempore aut fuga veritatis asperiores?';
console.log(text);
